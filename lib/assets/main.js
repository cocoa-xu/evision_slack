export function init(ctx, payload) {
      ...
      <form>
        <div class="container">
          <div class="row header">
            ...
            <div class="inline-field">
              <label class="inline-input-label">Image</label>
              <input class="input input--xs input-text" id="image-variable" placeholder="Var name">
            </div>
            <div class="grow"></div>
          ...
          <div class="help-box" x-cloak x-show="helpBoxOpen">
            <div class="section">
              <p>
                This Smart cell sends an image to a Slack channel. In order to use it, you need to
  ...
  const imageVarEl = document.getElementById("image-variable");
  imageVarEl.value = payload.fields.imageVar;
  ...
  imageVarEl.addEventListener("change", (event) => {
